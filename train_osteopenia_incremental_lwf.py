    ...
    for fold, (train_indices, val_indices) in enumerate(splits2):
        ...
        for i in range(epochs):
            ...
            for train_data,train_label in tqdm(train_dataloader2):
                ...
                distill_loss=distillation_loss(new_output,old_output,T=T)*ewc_lambda
        ...
        if best_test_acc<harmonic_test_acc:
                ...
                torch.save(model.state_dict(),f'model/{model_name}_incremental_lwf_3_classbest_param.pkl')  
