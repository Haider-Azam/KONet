...
if __name__=='__main__':
    ...
    factor=augmented_dataset_size//len(non_augmented_dataset)
    test_set=torch.utils.data.ConcatDataset([non_augmented_dataset]+[non_augmented_dataset for _ in range(factor)])
